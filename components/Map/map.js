...
export const Map = () => {
	...
	return (
		<div className="w-full flex">
			<div onClick={() => enableGlobeMode()} className="bg-black text-white cursor-pointer rounded p-2 top-0 right-0 z-40 absolute">
				Globe mode
			</div>
			<div onClick={() => enableStreetMode()} className="bg-black text-white cursor-pointer rounded p-2 top-30 right-0 z-40 absolute">
				Street mode
			</div>
